<?php
  ...
  if (isset($_POST['submit'])) {
   ...
   if ($password==$row['password']) {
     $q="UPDATE `admin` SET `firstname`='$firstname',`lastname`='$lastname' WHERE `admin_id`=$id";
     $r=mysqli_query($dbc,$q);
    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <?php 
          ...
          $row=mysqli_fetch_assoc($r);
         ?>
        <form action="user_update2.php?id=<?= $id ?>" method="post">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="user_update_password2.php?id=<?= $id ?>"> Modifier le mot de passe</a>
