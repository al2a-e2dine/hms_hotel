  ...
  if (isset($_POST['submit'])) {
   ...
   if ($old_password==$row['password']) {
    if ($n_password==$n_password2) {
      ...
      $q="UPDATE `admin` SET `password`='$n_password' WHERE `admin_id`='$id'";
      $r=mysqli_query($dbc,$q);
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <?php 
       ...
       ?>
      <div class="card-body">
        <form action="user_update_password2.php?id=<?= $id ?>" method="post">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="user_update2.php?id=<?= $id ?>">Mettre à jour les informations utilisateur</a>
