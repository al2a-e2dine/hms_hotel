        ...
        <section class="gallery_area section_gap">
            <div class="container">
                <div class="section_title text-center">
                    <h2 class="title_color">HOTEL KADI Ex EL MENZEH</h2>
                ...
                <div class="row imageGallery1" id="gallery">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/07.jpg" alt="">
                            <div class="hover">
                                <a class="light" href="image/gallery/07.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/08.jpg" alt="">
                            <div class="hover">
                                <a class="light" href="image/gallery/08.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/09.jpg" alt="">
                            <div class="hover">
                                <a class="light" href="image/gallery/09.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/10.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/11.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/12.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/13.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/14.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/15.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            ...
                            <div class="hover">
                                <a class="light" href="image/gallery/16.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
